...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:fl_chart/fl_chart.dart';
import 'inprogressstaskscreen.dart'; // Import the new screen

class TaskPieChartScreen extends StatefulWidget {
  const TaskPieChartScreen({super.key});
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: isLoading
            ? const Center(child: CircularProgressIndicator())
            : Padding(
          padding: const EdgeInsets.only(top: 10.0,bottom: 20,right: 12,left: 12),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Text(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const InProgressTasksScreen(),
                        ),
                      );
                    },
                    child: Container
                      ...
                      child: const Text("Task In Progress"),
                    ),
                  ),
                ),
              ),
